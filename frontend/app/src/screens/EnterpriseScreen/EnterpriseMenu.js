    ...
    const fetchStats = async () => {
      try {
        const [registerVehicle, registerOrder] = await Promise.all([
          axios.get(`https://36969c99d270.ngrok-free.app/api/registerVehicle/count/${idCollector}`),
          axios.get(`https://36969c99d270.ngrok-free.app/api/registerOrder/status/count/${idCollector}`)
        ]);
